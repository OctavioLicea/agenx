...
> ajustados a la guía, botones de contacto de la asesora; y un fix más
> tras la primera prueba real de Okta en `localhost` — `max-width`
> inconsistente entre header/galería y el cuerpo).
